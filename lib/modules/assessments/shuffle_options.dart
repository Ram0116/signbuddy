...
void shuffleOptions(List<Map<String, dynamic>> assessmentQuestions) {
  ...
  if (!optionsShuffled) {
    ...
    for (var question in assessmentQuestions) {
      var options = List<String>.from(question['options']); // Make a copy of the original options
      var correctAnswerIndex = question['correctAnswerIndex']; // Get the original correct answer index
