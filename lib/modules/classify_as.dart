...
class _ClassifyState extends State<Classify> {
  ...
  Widget build(BuildContext context) {
     return loading ? const Loading(text: 'Loading . . . ') : Scaffold(
      body: Container(
          ...
          children: [
            Container(
              ...
              child: CustomBackButton(
                onPressed: () {
                  Navigator.push(context, SlidePageRoute(page: const ChooseLanguages())); // Handle routing here
                },
              ),
            ),
            Container(
  ...
  Future<void> _navigateToLevel(BuildContext context, String classify) async {
    try {
      ...
      if (currentUser != null) {
        ...
        switch (classify) {
          case 'Non-Disabled':
             Navigator.push(context, SlidePageRoute(page: const Level()));
            break;
          case 'Deaf or Hard-of-Hearing':
             Navigator.push(context, SlidePageRoute(page: const AssessmentOne()));
            break;
