...
import 'package:flutter_application/modules/sharedwidget/congrats.dart';
...
class LessonF extends StatefulWidget {
  const LessonF({Key? key, required int lessonPage}) : super(key: key);

  @override
  State<LessonF> createState() => _LessonFState();
}

class _LessonFState extends State<LessonF> {
  int lessonPage = 1;
  ...
  Future<void> _loadProgress() async {
    ...
    int? savedPage = prefs?.getInt('lesson_f_progress') ?? 1;
    setState(() {
  ...
  void _saveProgress() async {
    prefs?.setInt('lesson_f_progress', lessonPage);
  }
      ...
      children: [
        const Align(
          ...
          child: Padding(
            ...
            child: Text(
              'This is the sign language for letter "F"',
      ...
      children: [
        ...
        Container(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(10),
            child: Image.asset(
              'assets/alphabet-lesson/d-f-img/fish.gif',
            ),
          ),
        ),
      ],
