...
import 'package:flutter_application/modules/lessons/alphabet/d-f/lesson_e.dart';
...
class _LessonDState extends State<LessonD> {
  int lessonPage = 1;
  ...
  final List<Map<String, dynamic>> quizQuestions = [
    {
      ...
      'imageUrl': 'assets/assess-img/question-five/d.png',
      'options': ['C', 'X', 'F', 'D', 'M', 'E'],
  ...
  Future<void> _loadProgress() async {
    ...
    int? savedPage = prefs?.getInt('lesson_d_progress') ?? 1;
    setState(() {
  ...
  void _saveProgress() async {
    prefs?.setInt('lesson_d_progress', lessonPage);
  }
    ...
    setState(() {
      ...
      if (lessonPage > maxPages) {
        Navigator.push(
          context,
          SlidePageRoute(
            page: LessonE(lessonPage: lessonPage,),
          ),
        );
      }
    });
      ...
      children: [
        const Align(
          ...
          child: Padding(
            ...
            child: Text(
              'This is the sign language for letter "D"',
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: Image.asset(
              'assets/alphabet-lesson/d-f-img/d.png',
            ),
          ),
        ),
      ],
      ...
      children: [
        ...
        Container(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(10),
            child: Image.asset(
              'assets/alphabet-lesson/d-f-img/dolphin.gif',
            ),
          ),
        ),
      ],
