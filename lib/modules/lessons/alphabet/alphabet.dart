...
class _LettersState extends State<Letters> {
  final List<Map<String, dynamic>> lessonLetters = [
    {'letter': 'Alphabet A-D', 'subtext': 'Learn new signs', 'lessonPage': 0},
    {'letter': 'Alphabet E-H', 'subtext': 'Learn new signs', 'lessonPage': 1},
    {'letter': 'Alphabet I-L', 'subtext': 'Learn new signs', 'lessonPage': 2},
    {'letter': 'Alphabet M-P', 'subtext': 'Learn new signs', 'lessonPage': 3},
    {'letter': 'Alphabet Q-T', 'subtext': 'Learn new signs', 'lessonPage': 4},
    {'letter': 'Alphabet U-X', 'subtext': 'Learn new signs', 'lessonPage': 5},
    {'letter': 'Alphabet Y-Z', 'subtext': 'Learn new signs', 'lessonPage': 8},
  ];
  ...
  void navigateToLesson(String letter, int lessonPage) {
    switch (letter) {
      case 'Alphabet A-D':
        Navigator.push(
          context,
          SlidePageRoute(page: const LessonA()),
        );
        break;
      case 'Alphabet E-H':
        Navigator.push(
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        navigateToLesson(
                            lesson['letter'], lesson['lessonPage']);
                      },
                    ),
                  ),
                );
