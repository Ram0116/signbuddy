...
import 'package:flutter_application/front-page/assessments/assess_seven.dart';
  ...
  final List<Map<String, dynamic>> assessmentQuestions = [
    {
      ...
      'videoUrl': 'assess-img/question-six/baby1.gif',
      'options': [
  ...
  void navigateToNextAssessment(BuildContext context) {
    if (currentIndex < assessmentQuestions.length - 1) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AssessmentSix(score: widget.score + score),
        ),
      );
    } else {
