...
import 'package:flutter_application/front-page/assessments/assess_eight.dart';
...
class _AssessmentSevenState extends State<AssessmentSeven> {
  ...
  final List<Map<String, dynamic>> assessmentQuestions = [
    {
      'question': 'Select the correct sign for "T"',
      'options': [
        'assess-img/question-seven/p.png',
        'assess-img/question-seven/q.png',
        'assess-img/question-seven/t.png',
        'assess-img/question-seven/u.png',
      ],
  ...
  void navigateToNextAssessment(BuildContext context) {
    if (currentIndex < assessmentQuestions.length - 1) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AssessmentEight(score: widget.score + score),
        ),
      );
    }
  }
